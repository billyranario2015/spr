			...
			<div class="container" id="main-menu-container">
				...
				<nav class="navbar-collapse bs-navbar-collapse collapse" id="main-menu-wrapper" aria-expanded="false" style="height: 1px;">
					<ul class="nav navbar-nav navbar-right" id="main-menu">
						...
						<li><a href="#">Help</a></li>
						<li><a href="{{ url( 'auth/login' ) }}" class="login-buttons"><button class="btn btn-default">LOGIN</button></a></li>
						<li><a href="{{ url( 'auth/register' ) }}" class="login-buttons"><button class="btn btn-default">REGISTER</button></a></li>
					</ul>					
				</nav>
			</div>
		</section>				
